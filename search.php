...
<body>
 ...
 <!--Delete selected file option at the bottom of table-->
<tr align="center"><th colspan="10" align="center"><a href ="javascript:void(0)" onclick="delete_all()" >Delete Selected</a></th></tr></table>

<a href="producttable.php"><button type="submit" name="save"class="btn btn-primary btn-block btn-lg">All Products</button></a></form>
  <br>
<br><br>
